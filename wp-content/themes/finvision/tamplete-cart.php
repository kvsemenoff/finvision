		...
		<div class="row no-gutter">   <!-- ********************  no-gutter -->
			<div class="col-md-12 col-sm-12 col-xs-12 ah-wrapper">
				<div class="col-md-4 col-sm-12 col-xs-12">
					...
					<h1 class="ah-h1">FinnVision — B7</h1>
				...
				<div class="col-md-6 col-sm-12 col-xs-12">
					<div class="ah-right-block">
						<ul class="ah-cart-list3">
							<li>Размер ЖК-экрана – 3.0 inch 16:9 LCD — High Definition</li>
							<li>Разрешение – Full HD (1280×720 – 1920×1080)</li>
							<li>Угол обзора – Wide Angle lens 170</li>
							<li>Датчик движения –  Есть</li>
							<li>Датчик удара – Есть</li>
						</ul>

						<div class="ah-line"></div>

						<ul class="ah-cart-list4">
							<li>Ночная съемка – Есть</li>
							<li>Формат видео – AVI</li>
							<li>Формат фото – JPEG</li>
							<li>Дополнительные разъемы – HDMI, AV</li>
							<li>Карта памяти – microSD, microSDHC</li>
							<li>Микрофон – Есть (можно отключить)</li>
						</ul>

						<div class="ah-line"></div>

						<ul class="ah-cart-list5">
							<li>Динамик – Есть (можно отключить)</li>
							<li>Интерфейс USB – USB 2.0</li>
						</ul>
						<div class="col-md-12 col-sm-12 col-xs-12 no-padding">
							<a href="#" class="ah-cart-link1">Купить в интернет-магазине</a>
							<a href="#" class="ah-cart-link2">Купить <strong>в 1 клик</strong></a>
						</div>
					</div>
				</div>
			</div>	
